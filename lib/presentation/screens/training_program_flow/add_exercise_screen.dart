  ...
  Widget build(BuildContext context) {
    return Consumer<PresetProvider>(
      builder: (BuildContext context, presetData, Widget? child) {
        List<dynamic> listItems = presetData.presetExercises;
        ...
        if (selectedPresetItems.isEmpty) {
          buttonLabel = 'Select exercises';
        } else if (selectedPresetItems.length == 1) {
          buttonLabel = 'Add 1 exercise';
        } else {
          buttonLabel = 'Add ${selectedPresetItems.length} exercises';
        }
